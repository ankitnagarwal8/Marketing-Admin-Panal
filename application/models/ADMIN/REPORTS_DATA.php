...
class REPORTS_DATA extends CI_Model{
  ...
  public function getuserList(){
     $this->db->select(array('id', 'name', 'email', 'catagary', 'camaping', 'sending_email', 'subject', 'massage', 'sending_time', 'sending_date', 'delivered', 'delivered_date', 'seen', 'opening_date'));
        $this->db->from('report_data'); 
